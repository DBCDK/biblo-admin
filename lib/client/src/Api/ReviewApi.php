...
class ReviewApi
{
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function reviewSearch($q, $fields = null, $limit = null, $from = null)
    {
        list($response) = $this->reviewSearchWithHttpInfo($q, $fields, $limit, $from);
        return $response;
    }

    /**
     * Operation reviewSearchWithHttpInfo
     *
     * Searches via elastic search
     *
     * @param string $q URI search string (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function reviewSearchWithHttpInfo($q, $fields = null, $limit = null, $from = null)
    {
        // verify the required parameter 'q' is set
        if ($q === null) {
            throw new \InvalidArgumentException('Missing the required parameter $q when calling reviewSearch');
        }
        // parse inputs
        $resourcePath = "/reviews/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function reviewSuggest($q)
    {
        list($response) = $this->reviewSuggestWithHttpInfo($q);
        return $response;
    }

    /**
     * Operation reviewSuggestWithHttpInfo
     *
     * Suggestions via elastic search
     *
     * @param string $q String to suggest upon (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function reviewSuggestWithHttpInfo($q)
    {
        // verify the required parameter 'q' is set
        if ($q === null) {
            throw new \InvalidArgumentException('Missing the required parameter $q when calling reviewSuggest');
        }
        // parse inputs
        $resourcePath = "/reviews/suggest";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
