...
class GroupApi
{
    ...
    /**
     * Operation groupPrototypeGetCampaign
     *
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeGetCampaign($id, $refresh = null)
    {
        list($response) = $this->groupPrototypeGetCampaignWithHttpInfo($id, $refresh);
        return $response;
    }

    /**
     * Operation groupPrototypeGetCampaignWithHttpInfo
     *
     * Fetches belongsTo relation campaign.
     *
     * @param string $id PersistedModel id (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeGetCampaignWithHttpInfo($id, $refresh = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling groupPrototypeGetCampaign');
        }
        // parse inputs
        $resourcePath = "/Groups/{id}/campaign";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupSearch($q, $fields = null, $limit = null, $from = null)
    {
        list($response) = $this->groupSearchWithHttpInfo($q, $fields, $limit, $from);
        return $response;
    }
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupSearchWithHttpInfo($q, $fields = null, $limit = null, $from = null)
    {
        // verify the required parameter 'q' is set
        if ($q === null) {
            throw new \InvalidArgumentException('Missing the required parameter $q when calling groupSearch');
        }
        // parse inputs
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupSuggest($q)
    {
        list($response) = $this->groupSuggestWithHttpInfo($q);
        return $response;
    }

    /**
     * Operation groupSuggestWithHttpInfo
     *
     * Suggestions via elastic search
     *
     * @param string $q String to suggest upon (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupSuggestWithHttpInfo($q)
    {
        // verify the required parameter 'q' is set
        if ($q === null) {
            throw new \InvalidArgumentException('Missing the required parameter $q when calling groupSuggest');
        }
        // parse inputs
        $resourcePath = "/Groups/suggest";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
