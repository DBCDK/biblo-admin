...
class CommentApi
{
    ...
    /**
     * Operation commentPrototypeGetReview
     *
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function commentPrototypeGetReview($id, $refresh = null)
    {
        list($response) = $this->commentPrototypeGetReviewWithHttpInfo($id, $refresh);
        return $response;
    }

    /**
     * Operation commentPrototypeGetReviewWithHttpInfo
     *
     * Fetches belongsTo relation review.
     *
     * @param string $id PersistedModel id (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function commentPrototypeGetReviewWithHttpInfo($id, $refresh = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling commentPrototypeGetReview');
        }
        // parse inputs
        $resourcePath = "/Comments/{id}/review";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function commentSearch($q, $fields = null, $limit = null, $from = null)
    {
        list($response) = $this->commentSearchWithHttpInfo($q, $fields, $limit, $from);
        return $response;
    }

    /**
     * Operation commentSearchWithHttpInfo
     *
     * Searches via elastic search
     *
     * @param string $q URI search string (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function commentSearchWithHttpInfo($q, $fields = null, $limit = null, $from = null)
    {
        // verify the required parameter 'q' is set
        if ($q === null) {
            throw new \InvalidArgumentException('Missing the required parameter $q when calling commentSearch');
        }
        // parse inputs
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function commentSuggest($q)
    {
        list($response) = $this->commentSuggestWithHttpInfo($q);
        return $response;
    }

    /**
     * Operation commentSuggestWithHttpInfo
     *
     * Suggestions via elastic search
     *
     * @param string $q String to suggest upon (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function commentSuggestWithHttpInfo($q)
    {
        // verify the required parameter 'q' is set
        if ($q === null) {
            throw new \InvalidArgumentException('Missing the required parameter $q when calling commentSuggest');
        }
        // parse inputs
        $resourcePath = "/Comments/suggest";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
