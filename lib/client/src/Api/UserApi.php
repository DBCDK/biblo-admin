...
class UserApi
{
    ...
    public function userCreateWithHttpInfo($data = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\DBCDK\CommunityServices\Model\User',
                '/Users'
            );
    ...
    {
        list($response) = $this->userPrototypeDestroyByIdAccessTokensWithHttpInfo($fk, $id);
        return $response;
    }
    ...
    {
        list($response) = $this->userPrototypeFindByIdAccessTokensWithHttpInfo($fk, $id);
        return $response;
    }
    ...
    /**
     * Operation userPrototypeUpdateAttributes
     *
    ...
    {
        list($response) = $this->userPrototypeUpdateAttributesWithHttpInfo($id, $data);
        return $response;
    }

    /**
     * Operation userPrototypeUpdateAttributesWithHttpInfo
     *
     * Update attributes for a model instance and persist it into the data source.
     *
     * @param string $id User id (required)
    ...
    {
        list($response) = $this->userPrototypeUpdateByIdAccessTokensWithHttpInfo($fk, $id, $data);
        return $response;
    }
    ...
    {
        list($response) = $this->userUpsertWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation userUpsertWithHttpInfo
     *
     * Update an existing model instance or insert a new one into the data source.
     *
     * @param \DBCDK\CommunityServices\Model\User $data Model instance data (optional)
