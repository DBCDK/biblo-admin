 ...
 */
class QuizListForm extends FormBase
{
    ...
    public static function create(ContainerInterface $container)
    {
        ...
        $path = $container->get('config.factory')->get('dbcdk_community.settings')->get('community_service_url');
        $quiz_client = new QuizClient($path);
    ...
    {
        return 'dbcdk_community_moderation_quiz_list_form';
    }
